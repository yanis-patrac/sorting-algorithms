...
def draw_ui(algorithm, circle_count):
    draw_button("Nouvelles couleurs", pygame.Rect(275, HEIGHT - 190, 250, 50), generate_new_colors)
    draw_button("Démarrer le tri", pygame.Rect(300, HEIGHT - 500, 200, 50), lambda: start_sorting(algorithm))
...
while running:
    ...
    if sorting:
        draw_text("Tri en cours...", 320, HEIGHT - 310)
